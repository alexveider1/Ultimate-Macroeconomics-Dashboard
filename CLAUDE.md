...
| `downloader_general` | —    | One-shot: bootstraps LLM role, ingests WB + Yahoo + Binance + FRED + Eurostat + news, populates both DBs              |
