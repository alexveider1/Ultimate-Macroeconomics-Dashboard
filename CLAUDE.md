...
| `downloader_general` | —    | One-shot: bootstraps LLM role, ingests WB + Yahoo + Binance + FRED + Eurostat + news (Webhose + Actually Relevant + World Bank docs), populates both DBs |
