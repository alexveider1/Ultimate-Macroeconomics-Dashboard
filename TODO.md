...
* Pages with graph-based analysis
* Unification of all ML/DL models into one runtime (either NVIDIA Triton or ONNX)
* Option for RAG on graph-based knowledge database
* Voice and file input for AI-agent
