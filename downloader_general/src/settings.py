...
Bank / Yahoo / news ingestion, so it legitimately needs the superuser creds, the
LLM-role creds, the OpenAI key (news embeddings) and the Qdrant key. Every field
